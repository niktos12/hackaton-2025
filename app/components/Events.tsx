      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-8 sm:gap-12 lg:gap-16">
            <div
              ref={citiesRef}
              className="opacity-0 flex flex-col gap-4 sm:gap-6 items-stretch sm:items-center lg:flex-row lg:justify-between"
            >
                  ...
                  <button
                    ...
                    className={`px-4 sm:px-6 py-2 sm:py-3 rounded-full transition-all duration-300 text-sm sm:text-lg font-semibold ${
                      selectedCity === city
                        ...
                        : "bg-[#D4D4D8] text-black hover:bg-gray-300"
                    }`}
                  >
                    {city}
                  </button>
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 z-10 pointer-events-none">
                    <div className="absolute left-0 right-0 top-0 h-1/2 bg-gradient-to-t from-transparent to-white"></div>
                  </div>
